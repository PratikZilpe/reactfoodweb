...
function Meal() {
    ...
    const onSearchClick = () => {
        {
        fetch(`https://www.themealdb.com/api/json/v1/1/search.php?s=${search}`).then(res=>res.json()).then(data=> {setMeal(data.meals);
        setSearch("")})
        } 
    }
    ...
    <>
        <div className="main">
            ...
            <div className="searchBox">
                    ...
                    <button className='search_button' onClick={onSearchClick}>Search</button>
            </div>
